...
import './lockpaper.css'

const LockPaper = ({id}) => {
 
    return (
        <div  style={{position:"absolute",top:'88%',left:"91%"}}>
            <input className='inpLock1' id={`myinput${id}`}  type="checkbox" />
            <label className="btn-lock1" htmlFor={`myinput${id}`}>
                <svg width="36" height="40" viewBox="0 0 36 40">
                    <path className="lockb1"
                     ...
                     <path className="lock1" d="M6 21V10C6 5.58172 9.58172 2 14 2V2C18.4183 2 22 5.58172 22 10V21"></path>
                </svg>
            </label>
        </div>
    )
